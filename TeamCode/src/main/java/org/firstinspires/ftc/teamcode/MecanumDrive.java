...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.7343214771822217; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 14.344416235785948;

        // feedforward parameters (in tick units)
        public double kS = 0.7762180570667687;
        public double kV = 0.14414402789567402;
