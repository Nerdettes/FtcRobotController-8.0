...
@Autonomous(name = "RedCookiePath2Back", group = "")
public class RedCookiePath2Back extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(new SequentialAction(
                ...
                ks.drive.actionBuilder(new Pose2d(new Vector2d(-24.0, -36.0), Math.toRadians(0.0)))
                        ...
                        .splineTo(new Vector2d(-54.0, -36.0), Math.toRadians(0.0),new MinVelConstraint(Arrays.asList(new TranslationalVelConstraint(20.0),new AngularVelConstraint(Math.PI / 2))))
                        .build(),
                ks.rest(),
                ks.drive.actionBuilder(new Pose2d(new Vector2d(-54.0, -36.0), Math.toRadians(0.0)))
                        // .setTangent(Math.toRadians(-180.0))
                        .strafeToLinearHeading(new Vector2d(-10.0, 11.0), Math.toRadians(225.0))
                        .build(),
                ks.shoot(0.49),
