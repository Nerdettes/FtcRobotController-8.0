...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2.375/(1.0/(19.89436789*25.4)); // y position of the parallel encoder (in tick units)
        public double perpXTicks = -12.0/(1.0/(19.89436789*25.4)); // x position of the perpendicular encoder (in tick units)
    }
